...
public class Validation {
    ...
    public static final String NUMBER_REGEX_PATTERN="^[0-9]{1,3}$";
    ...
    public static boolean isValidNumber(String power) {
        Pattern pattern=Pattern.compile(NUMBER_REGEX_PATTERN);//Kuriamas sablonas pagal musu stringa
        Matcher matcher=pattern.matcher(power);//Palyginamas sablonas su vartotojo ivestais duomenimis
        return matcher.find();
    }
}
